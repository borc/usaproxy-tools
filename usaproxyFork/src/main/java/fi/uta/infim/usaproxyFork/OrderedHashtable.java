...
public class OrderedHashtable {
    ...
    private Vector<String>    orderedKeys;
    
    /** holds the ordered <code>Hashtable</code> keys in lower case. */
    private Vector<String>    orderedKeysLower;
    ...
    public OrderedHashtable() {
        orderedKeys 		= new Vector<String>();
        orderedKeysLower 	= new Vector<String>();
    ...
    public OrderedHashtable(int initialCapacity) {
        orderedKeys 		= new Vector<String>(initialCapacity);
        orderedKeysLower 	= new Vector<String>(initialCapacity);
        hashTable 			= new Hashtable<String, String>(initialCapacity);
    }
